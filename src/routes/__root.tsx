...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Nihongolive" },
      { name: "mobile-web-app-capable", content: "yes" },

      { title: "Nihongolive — Natural Japanese AI Coach" },
      { name: "description", content: "Belajar berbicara seperti orang Jepang — bukan sekadar lulus JLPT" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Nihongolive — Belajar Bahasa Jepang Natural dengan AI" },
      { property: "og:description", content: "Belajar berbicara seperti orang Jepang — bukan sekadar lulus JLPT" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Nihongolive — Belajar Bahasa Jepang Natural dengan AI" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Inter:wght@400;600;800;900&display=swap", fetchpriority: "high" },
