...
const EN: Dict = {
  ...
  "dash.signin.title": "Sign in to see your progress",
  "dash.signin.desc": "Track your interview history, grammar/naturalness/confidence scores, and favorites.",
  "dash.iv.title": "Interview Progress",
  "dash.iv.label": "Job Interview Practice",
  "dash.iv.loading": "Loading…",
  "dash.iv.empty": "No interview sessions yet. Start your first practice now.",
  "dash.iv.start": "Start Interview",
  "dash.iv.lastSessions": "Recent sessions",
  "dash.iv.newSession": "Start a new session",
  "dash.iv.done": "Completed",
